    ...
    <?php include '../../includes/header.php'; ?>
        ...
        <div class="flex-1 overflow-auto px-8 py-7">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
                <div class="card rounded-md">
                    ...
                    <div class="info-block grid grid-cols-2 gap-y-5 gap-x-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <p class="info-value" style="font-weight:400; font-size:13px;">
                ...
                <div class="card rounded-md">
                    <div class="px-5 py-4 border-b" style="border-color: var(--line-soft);">
                        <h3 class="text-[14px] font-semibold tracking-tight flex items-center gap-2" style="color: var(--ink);"><i data-lucide="truck" class="w-4 h-4 text-gray-500"></i> Merchant / Supplier Details</h3>
                    </div>
                    <div class="info-block grid grid-cols-2 gap-y-5 gap-x-4">
                        <?php if ($supplier): ?>
                            <div class="col-span-2">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="text-[11px] uppercase tracking-[0.08em] border-b" style="color: var(--mute); border-color: var(--line-soft); background: var(--paper-dim);">
                                ...
                                <th class="px-3 py-3 font-medium text-right">Discount</th>
                        ...
                        <tbody class="text-[13.5px] divide-y" style="border-color: var(--line-soft);">
                            <?php if (empty($items)): ?>
                                <tr>
                                    <td colspan="6" class="px-5 py-8 text-center text-[13px]" style="color: var(--mute);">No specific line items recorded for this order. Total value derived from specs.</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($items as $item): ?>
                                <tr class="transition-colors" style="border-color: var(--line-soft);" onmouseover="this.style.background='var(--paper-dim)'" onmouseout="this.style.background='transparent'">
                                    <td class="pl-5 pr-3 py-3.5 mono font-medium" style="color: var(--ink);"><?= htmlspecialchars($item['item_code'] ?? 'N/A') ?></td>
                                    ...
                                    <td class="px-3 py-3.5 text-right num" style="color: var(--mute);"><?= number_format($item['discount_pct'], 2) ?>%</td>
