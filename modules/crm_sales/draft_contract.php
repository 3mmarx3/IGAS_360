                    ...
                    <div class="lg:col-span-2 flex flex-col gap-6">
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <select class="form-input mono">
                                        ...
                                        <option value="1">SABIC Petrochemicals</option>
                                        <option value="2">Air Product Co.</option>
                                        <option value="3">Tabuk Steel Works</option>
                                        <option value="4">Red Sea Marine Services</option>
                                    </select>
                                </div>
                                <div class="col-span-2 md:col-span-1">
                                    <label class="form-label">Contract Reference (Auto)</label>
                                    <input type="text" class="form-input mono num" value="CTR-7046" disabled>
                                </div>
                                <div class="col-span-2">
                                    <label class="form-label">Billing Address / Plant Location</label>
                                    <input type="text" class="form-input" placeholder="e.g. Plot 42, Industrial Zone, Yanbu">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card rounded-md p-6">
                            ...
                            <div>
                                ...
                                <textarea class="form-input" rows="4" placeholder="Enter specific delivery instructions, purity requirements, or penalty clauses..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="card rounded-md p-6">
                            ...
                            <div class="flex flex-col gap-5">
                                <div>
                                    ...
                                    <input type="number" class="form-input mono num text-[16px] font-semibold" placeholder="0.00" style="color: var(--ink);">
                                </div>
                                <div>
