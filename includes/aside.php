    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="pt-6">
            ...
            <nav class="px-3">
                ...
                <a href="/IGAS_360/modules/logistics_fleet/licenses_alerts.php" class="nav-row <?= (isset($active_page) && $active_page == 'licenses_alerts') ? 'active' : '' ?> flex items-center gap-3 px-3 py-2.5 rounded-sm font-medium text-[13.5px]">
            ...
            <nav class="px-3">
                ...
                <a href="/IGAS_360/modules/insights/partner_approvals.php" class="nav-row <?= (isset($active_page) && $active_page == 'partner_approvals') ? 'active' : '' ?> flex items-center gap-3 px-3 py-2.5 rounded-sm font-medium text-[13.5px] mb-0.5">
